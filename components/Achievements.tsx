...
export default function Achievements() {
  return (
    <SectionWrapper id="achievements" number="06" title="TIMELINE">
      <div className="font-mono text-xs text-[#4a8a4f] uppercase tracking-widest mb-6">
        <span className="text-[#00ff41]">{">"}</span> tail -f ./career.log
      </div>
            ...
            >
              ...
              <div className="card p-3">
                ...
                <p className="text-[10px] text-[#a8e6a8] leading-relaxed">
                  <span className="text-[#00ff41]">▸</span> {item.description}
                </p>
              </div>
            </motion.div>
          ))}
