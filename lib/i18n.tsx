...
const PT: Dict = {
  ...
  achievements: [
    ...
    { id: 3, title: "Certificações Udemy", description: "Power BI e Sistema Operacional Linux — cursos independentes de reforço técnico." },
    { id: 4, title: "Linux LPIC-1 — SENAI", description: "Sistemas Operacionais Linux, Instalação e Configuração." },
    { id: 5, title: "Início Ciência da Computação — UNIP", description: "Início oficial da graduação na Universidade Paulista (2025—2028)." },
    { id: 6, title: "Estágio na Prefeitura de Osasco", description: "Front-end, desenvolvimento web e análise de sistemas (Abr 2025 — Abr 2026)." },
    { id: 7, title: "Certificações FIAP", description: "Chatbots (Mar 2026) e Big Data e Analytics (Abr 2026) — trilha de dados e IA aplicada." },
    { id: 8, title: "Estágio na Atrys Brasil", description: "Analista de Sistemas em ambiente híbrido — São Paulo." },
    { id: 9, title: "Certificações Microsoft + Oracle", description: "Azure AI applications & agents, GitHub Fundamentals (Microsoft Learning) e Certified AI Foundations Associate (Oracle)." },
    { id: 10, title: "IBM AI Fundamentals", description: "Artificial Intelligence Fundamentals — chatbots, redes neurais e machine learning." },
    { id: 11, title: "EcoCity + CloudOps Copilot", description: "Projeto Java (APS UNIP) e participação no CloudOps Copilot 1.0." },
  ],
  personal: {
...
const EN: Dict = {
  ...
  achievements: [
    ...
    { id: 3, title: "Udemy Certifications", description: "Power BI and Linux Operating System — independent technical courses." },
    { id: 4, title: "Linux LPIC-1 — SENAI", description: "Linux Operating Systems, Installation and Configuration." },
    { id: 5, title: "Started Computer Science — UNIP", description: "Official start of undergraduate studies at Universidade Paulista (2025—2028)." },
    { id: 6, title: "Internship at Osasco City Hall", description: "Front-end, web development and systems analysis (Apr 2025 — Apr 2026)." },
    { id: 7, title: "FIAP Certifications", description: "Chatbots (Mar 2026) and Big Data & Analytics (Apr 2026) — data and applied AI track." },
    { id: 8, title: "Internship at Atrys Brasil", description: "Systems Analyst in hybrid environment — São Paulo." },
    { id: 9, title: "Microsoft + Oracle Certifications", description: "Azure AI applications & agents, GitHub Fundamentals (Microsoft Learning) and Certified AI Foundations Associate (Oracle)." },
    { id: 10, title: "IBM AI Fundamentals", description: "Artificial Intelligence Fundamentals — chatbots, neural networks and machine learning." },
    { id: 11, title: "EcoCity + CloudOps Copilot", description: "Java project (UNIP final assignment) and contribution to CloudOps Copilot 1.0." },
  ],
  personal: {
...
const ES: Dict = {
  ...
  achievements: [
    ...
    { id: 3, title: "Certificaciones Udemy", description: "Power BI y Sistema Operativo Linux — cursos técnicos independientes." },
    { id: 4, title: "Linux LPIC-1 — SENAI", description: "Sistemas Operativos Linux, Instalación y Configuración." },
    { id: 5, title: "Inicio Ciencias de la Computación — UNIP", description: "Inicio oficial de la carrera en la Universidad Paulista (2025—2028)." },
    { id: 6, title: "Pasantía en la Alcaldía de Osasco", description: "Front-end, desarrollo web y análisis de sistemas (Abr 2025 — Abr 2026)." },
    { id: 7, title: "Certificaciones FIAP", description: "Chatbots (Mar 2026) y Big Data y Analytics (Abr 2026) — trayecto de datos e IA aplicada." },
    { id: 8, title: "Pasantía en Atrys Brasil", description: "Analista de Sistemas en entorno híbrido — São Paulo." },
    { id: 9, title: "Certificaciones Microsoft + Oracle", description: "Azure AI applications & agents, GitHub Fundamentals (Microsoft Learning) y Certified AI Foundations Associate (Oracle)." },
    { id: 10, title: "IBM AI Fundamentals", description: "Artificial Intelligence Fundamentals — chatbots, redes neuronales y machine learning." },
    { id: 11, title: "EcoCity + CloudOps Copilot", description: "Proyecto Java (trabajo final UNIP) y contribución a CloudOps Copilot 1.0." },
  ],
  personal: {
    title: "Analista de Sistemas",
    description:
