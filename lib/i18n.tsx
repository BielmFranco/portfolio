...
const PT: Dict = {
  ...
  achievements: [
    ...
    { id: 3, title: "Certificações FIAP + Udemy", description: "Python Development, Big Data e Analytics, Chatbots (FIAP) e Power BI + Linux (Udemy)." },
    ...
    { id: 8, title: "Certificações Microsoft + Oracle", description: "Azure AI applications & agents (Microsoft Learning) e Certified AI Foundations Associate (Oracle)." },
    { id: 9, title: "IBM AI Fundamentals", description: "Artificial Intelligence Fundamentals — chatbots, redes neurais e machine learning." },
    { id: 10, title: "EcoCity + CloudOps Copilot", description: "Projeto Java (APS UNIP) e participação no CloudOps Copilot 1.0." },
  ],
  personal: {
...
const EN: Dict = {
  ...
  achievements: [
    ...
    { id: 3, title: "FIAP + Udemy Certifications", description: "Python Development, Big Data & Analytics, Chatbots (FIAP) and Power BI + Linux (Udemy)." },
    ...
    { id: 8, title: "Microsoft + Oracle Certifications", description: "Azure AI applications & agents (Microsoft Learning) and Certified AI Foundations Associate (Oracle)." },
    { id: 9, title: "IBM AI Fundamentals", description: "Artificial Intelligence Fundamentals — chatbots, neural networks and machine learning." },
    { id: 10, title: "EcoCity + CloudOps Copilot", description: "Java project (UNIP final assignment) and contribution to CloudOps Copilot 1.0." },
  ],
  personal: {
...
const ES: Dict = {
  ...
  achievements: [
    ...
    { id: 3, title: "Certificaciones FIAP + Udemy", description: "Python Development, Big Data y Analytics, Chatbots (FIAP) y Power BI + Linux (Udemy)." },
    ...
    { id: 8, title: "Certificaciones Microsoft + Oracle", description: "Azure AI applications & agents (Microsoft Learning) y Certified AI Foundations Associate (Oracle)." },
    { id: 9, title: "IBM AI Fundamentals", description: "Artificial Intelligence Fundamentals — chatbots, redes neuronales y machine learning." },
    { id: 10, title: "EcoCity + CloudOps Copilot", description: "Proyecto Java (trabajo final UNIP) y contribución a CloudOps Copilot 1.0." },
  ],
  personal: {
    title: "Analista de Sistemas",
    description:
